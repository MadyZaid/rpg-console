...
import static in.ramakant.rpg.common.utils.StringUtils.isBlank;
...
public class ToStringBuilder {
    ...
    public ToStringBuilder append(String name, String value, Color color) {
        if (isBlank(name)) {
            System.out.println(String.format("name {} is empty", name));
            return this;
        }

        if (value == null) {
            System.out.println(String.format("value for name {} is null", name));
            return this;
        }
